...
var envSchema = import_zod.z.object({
  ...
  PORT: import_zod.z.string().transform((val) => parseInt(val, 10)).default("3000")
});
...
async function transactionsRoutes(app2) {
  ...
  app2.post("/", async (request, replay) => {
    const creatTransactionBodySchema = import_zod2.z.object({
